...
def sum_them_all(number):
    """
    2. Given a number, return the sum of all digits from
...
def how_many_days(days):
    """
    3. Given a certain amount of days, return a string
...
def whats_the_price(diameter, price):
    """
    4. Given the diameter and price of a pizza,
...
def how_much_on_taxes(price, total):
    """
    5. Given the price of a product and the total
...
def calories_per_day(current, goal, max_per_day):
    """
    6. Given current weith (kg), goal weight (kg), and
